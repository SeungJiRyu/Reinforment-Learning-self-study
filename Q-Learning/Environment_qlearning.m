classdef Environment_qlearning
    properties
        row (1,1) int16
        col (1,1) int16
        StateX (1,1) int16  = 1
    ...
    methods
        ...
        function e = Environment_qlearning(r,c,x,y,done,wall_table,x_destination,y_destination)
            e.row = r;
            e.col = c;
            e.StateX = x;
            e.StateY = y;
        ...
        function [x,y] = move_step(e,a)
            % arguments
            %     e Environment_qlearning
            %     a {mustBeMember(a,[1,2,3,4])}  % Represent up,down,left,right in order
            % end
            if a == 1 % up
                [a,b] = e.move_up();
            elseif a == 2 % down
